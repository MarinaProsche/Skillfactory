...
class PostForm(forms.ModelForm):
    ...
    #def head(self):
        #if not self.cleaned_data['head_post']:
            #self.head_post = Post.objects.order_by('-date_post').first().date_post
            #return self.head_post
    ...
    def clean(self):
        ...
        if not head_post:
            cleaned_data['head_post'] = datetime.datetime.now()
                ...
                #Post.objects.order_by('-date_post').first().date_post
